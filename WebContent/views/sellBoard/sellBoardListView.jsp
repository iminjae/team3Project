...
<%@ page language="java" contentType="text/html; charset=UTF-8"
   import="java.util.ArrayList, com.kh.team3.member.model.vo.Member" pageEncoding="UTF-8"%>
...
<body>
   ...
   <div class="container">
      <h2 class="text-center">판매 게시판</h2>
         ...
         <% if(userId != null){ %>
            <button onclick="location.href='<%=request.getContextPath() %>/sellInsertForm.bo'">작성하기</button>
         <% } %>
         </div>
      <br>
      <main class="mt-3">
               ...
               <div class="col-xl-3 col-lg-4 col-md-6">
                  ...
                  <div class="card" style="width: 220px;">
                     ...
                     <a href="/sellDetail.bo"><img
                        ...
                        width="200px" height="150px" class="card-img-top" alt="keyboard" /></a>
                     ...
                     <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                          ...
                          <button type="button" class="btn btn-sm btn-outline-secondary">버튼2</button>
                           ...
                           <small class="text-dark"><%=b.getCount() %></small>
                        </div>
                     </div>
                  </div>
                  <% } %>
