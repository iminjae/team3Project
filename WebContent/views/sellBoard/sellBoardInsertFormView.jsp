...
<body>
   ...
   <!-- 메인 -->
   <form id="insertForm" action="<%=request.getContextPath()%>/sellInsert.bo" method="post" enctype="multipart/form-data">
      <div class="container">
         ...
         <div class="mb-3 row">
            ...
            <div class="col-md-9">
               <div class="input-group mb-3">
                  <input type="number" class="form-control" name="price" placeholder="가격을 입력해 주세요"> <span
